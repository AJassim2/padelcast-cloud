...
#ifndef PADELCAST_SWIFT_H
#define PADELCAST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PadelCast",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC9PadelCast24WatchConnectivityManager")
...
@class WCSession;
@interface WatchConnectivityManager (SWIFT_EXTENSION(PadelCast))
- (void)sessionDidBecomeInactive:(WCSession * _Nonnull)session;
- (void)sessionDidDeactivate:(WCSession * _Nonnull)session;
@end

@class NSString;
@interface WatchConnectivityManager (SWIFT_EXTENSION(PadelCast)) <WCSessionDelegate>
