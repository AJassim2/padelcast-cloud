...
#ifndef PADELCAST_WATCH_APP_WATCH_APP_SWIFT_H
#define PADELCAST_WATCH_APP_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PadelCast_Watch_App_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC29PadelCast_Watch_App_Watch_App24WatchConnectivityManager")
...
@class WCSession;
@class NSString;
@interface WatchConnectivityManager (SWIFT_EXTENSION(PadelCast_Watch_App_Watch_App)) <WCSessionDelegate>
